...
def send(recipients=None, sender=None, subject=None, message=None, text_content=None, reference_doctype=None,
		...
		queue_separately=False, is_notification=False, add_unsubscribe_link=0, inline_images=None,
	...
	email_account = get_outgoing_email_account(True, append_to=reference_doctype, sender=sender, communication=communication)
