# Copyright (c) 2015-2022, libracore, Frappe Technologies Pvt. Ltd. and Contributors
...
def get_contact_name(email_id):
    ...
    contact_name = frappe.db.get_value('Contact', {'email_id': email_id})
    return contact_name
